...
$(function() {
  ...
  cssNode.innerHTML = "body { font-family: 'Consolas' sans-serif; }";
  ...
  cssNode.innerHTML += ".message{ display: block; white-space: normal;}";
  cssNode.innerHTML += ".jqconsole{ font-family: 'Consolas';}";
