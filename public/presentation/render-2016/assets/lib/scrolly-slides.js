/*
 * Scrolly Slides by @kosamari
 * Presentation slides in "Scrollytelling" format
 * https://github.com/kosamari/scrolly-slides
 ...
 */
  ...
  function handleWindowResize () {
    ...
    // var event = new CustomEvent('scrolly-slides-resized', { 'slideWidth': $el.slides.width() });
    window.dispatchEvent(new Event('scrolly-slides-resized'))

    // add bottom margin to the last section
    var $lastel = $('.scrolly-section:last-child')
 ...
 */
  ...
  this.init = function (opt) {
    ...
    $el.window.keydown(function (e) {
      if ($('.scrolly-focus-void').is(':focus')) {
        return;
      }
